...
normalises it through the pure :func:`~kdence.browser.site.normalize_site` policy and
hands the result to the :class:`~kdence.browser.tracker.BrowserTabTracker` the collector
