"""Dump a TimeKeeper span store -- the Step 4.3 verification helper.
...
Usage:
    uv run python -m timekeeper.storage PATH        # list spans + total
"""
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Dump a TimeKeeper span store (Step 4.3 check)")
